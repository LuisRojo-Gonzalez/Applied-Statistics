...
\begin{itemize}
\item Elección de distancia y test de Hopkins.
\item K-means vs PAM; DBSCAN/HDBSCAN y densidad variable.
\item GMM, EM y selección por BIC/ICL.
\item Linkage, dendrograma y cofenética.
\item Silhouette, CH, DB y estabilidad (Rand/NMI/VI).
\item En clustering no hay una ``verdad'' observable.
\end{itemize}
