...
\begin{enumerate}
\item \textbf{Problema, datos y disponibilidad temporal.} Decisión, unidad, clases, clase positiva y costo de FP/FN; fuente y licencia; qué información existe al corte.
\item \textbf{Calidad, prevalencia y desbalance.} Faltantes, dependencia, prevalencia global y por grupo; estrategia de desbalance.
\item \textbf{Validación y preparación.} Partición coherente, resamples comunes, semillas y preparación dentro de folds (sin leakage).
\item \textbf{Modelos y ajuste.} Baseline, logística, KNN, SVM, árbol, Random Forest y boosting; hiperparámetros y su selección.
\item \textbf{Discriminación, calibración y política.} ROC-AUC/PR-AUC con incertidumbre; log-loss/Brier; umbral o top-$k$ por costos y capacidad.
\item \textbf{Test, subgrupos, límites y recomendación.} Test único del sistema congelado; matriz de confusión; error por subgrupo; drift y recomendación.
\end{enumerate}
