...
\midrule
1 & Qué se predice, quién actúa y por qué el error tiene consecuencias. \emph{Problema y usuario:} Contexto y relevancia, Usuario de la predicción, Decisión apoyada, Unidad de análisis, Población objetivo. \emph{Respuesta y costo:} Respuesta continua, Instante y horizonte, Costo de sobre/subestimar, Restricción operacional. \\
2 & La elección se justifica por la decisión, no por disponibilidad. \emph{Fuente:} Fuente y licencia, Período y tamaño, Población. \emph{Pertinencia:} Variables y unidades, Disponibilidad al corte, Alternativa descartada. \\
3 & Muestre hallazgos que cambiaron decisiones y una relación estimada. \emph{Calidad:} Faltantes y mecanismo, Sesgo de selección, Outliers e influencia. \emph{Relación estimada:} Efecto con intervalo, Significancia vs relevancia, Supuestos. \\
4 & Mismos folds, test intacto, sin fuga. \emph{Partición:} Temporal o por grupos, Test intacto. \emph{CV y preparación:} Folds comunes y semillas, Transformaciones dentro de folds. \\
5 & Qué aporta cada familia y qué hiperparámetros la controlan. \emph{Lineal y regularización:} OLS y diagnóstico, Ridge, lasso, elastic-net, lambda y alfa. \emph{Flexibles y ensembles:} Splines o GAM, Árbol y Random Forest, Boosting. \\
6 & La mejor cifra puntual no basta: baseline y variabilidad. \emph{Métricas:} RMSE, MAE, R2, Frente al baseline. \emph{Estabilidad:} Incertidumbre entre folds, Sesgo--varianza. \\
7 & Patrones predictivos, no causalidad. \emph{Importancia:} Coeficientes, Importancia de variables. \emph{Efectos parciales:} PDP e ICE, Cautela causal. \\
8 & Una sola evaluación final del sistema elegido. \emph{Sistema final:} Modelo e hiperparámetros, Preprocesamiento congelado. \emph{Test:} Error e intervalos de predicción, Mejora vs baseline. \\
9 & Dónde y para quién falla el modelo. \emph{Residuos:} Curvatura y heterocedasticidad, Observaciones influyentes. \emph{Subgrupo crítico:} Error por subgrupo, Denominadores. \\
