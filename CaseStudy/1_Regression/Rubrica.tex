...
\begin{itemize}
\item Compromiso sesgo--varianza y validación cruzada.
\item Regularización: $\lambda$, $\alpha$ y \texttt{lambda.1se}.
\item No linealidad: splines y GAM.
\item Bagging vs boosting; importancia y PDP/ICE.
\item Fuga de información y partición coherente.
\item RMSE, MAE, $R^2$ e intervalos de predicción.
\end{itemize}
